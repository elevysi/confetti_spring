		...
		<div class="tp-banner">
			<ul>
				...
				<li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 1">
					<!-- MAIN IMAGE -->
					<img src="<c:url value='/thematic_1_9/Shop/assets/img/1.jpg'/> "  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
				...
				<li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 2">
					<!-- MAIN IMAGE -->
					<img src="<c:url value='/thematic_1_9/Shop/assets/img/5.jpg'/>"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
				...
				<li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 3">
					<!-- MAIN IMAGE -->
					<img src="<c:url value='/thematic_1_9/Shop/assets/img/3.jpg'/>"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="right top" data-bgrepeat="no-repeat">
				...
				<li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 4">
					<!-- MAIN IMAGE -->
					<img src="<c:url value='/thematic_1_9/Shop/assets/img/2.jpg'/>"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
				...
				<li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 5">
					<!-- MAIN IMAGE -->
					<img src="<c:url value='/thematic_1_9/Shop/assets/img/4.jpg'/>"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="right top" data-bgrepeat="no-repeat">
