<%@ include file="taglib.jsp"%>
                ...
                <ul class="list-unstyled blog-photos margin-bottom-30">
                    <li><a href="#"><img class="hover-effect" alt="" src="<c:url value='/resources/img/sliders/elastislide/5.jpg'/>"></a></li>
                    <li><a href="#"><img class="hover-effect" alt="" src="<c:url value='/resources/img/sliders/elastislide/6.jpg'/>"></a></li>
                    <li><a href="#"><img class="hover-effect" alt="" src="<c:url value='/resources/img/sliders/elastislide/8.jpg'/>"></a></li>
                    <li><a href="#"><img class="hover-effect" alt="" src="<c:url value='/resources/img/sliders/elastislide/10.jpg'/>"></a></li>
                    <li><a href="#"><img class="hover-effect" alt="" src="<c:url value='/resources/img/sliders/elastislide/11.jpg'/>"></a></li>
                    <li><a href="#"><img class="hover-effect" alt="" src="<c:url value='/resources/img/sliders/elastislide/1.jpg'/>"></a></li>
                    <li><a href="#"><img class="hover-effect" alt="" src="<c:url value='/resources/img/sliders/elastislide/2.jpg'/>"></a></li>
                    <li><a href="#"><img class="hover-effect" alt="" src="<c:url value='/resources/img/sliders/elastislide/7.jpg'/>"></a></li>
                </ul>
                <!-- End Photo Stream -->
