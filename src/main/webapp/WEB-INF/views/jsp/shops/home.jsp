	...
	<div class="container content-md">
			...
			<ul class="list-inline owl-slider">
				<li class="item">
					<div class="product-img">
						<a href="shop-ui-inner.html"><img class="full-width img-responsive" src="<c:url value='/thematic_1_9/Shop/assets/img/blog/09.jpg'/>" alt=""></a>
				...
				<li class="item">
					<div class="product-img">
						<a href="shop-ui-inner.html"><img class="full-width img-responsive" src="<c:url value='/thematic_1_9/Shop/assets/img/blog/26.jpg'/>" alt=""></a>
						<a class="product-review" href="shop-ui-inner.html">Quick review</a>
						<a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
					</div>
					<div class="product-description product-description-brd">
				...
				<li class="item">
					<div class="product-img">
						<a href="shop-ui-inner.html"><img class="full-width img-responsive" src="<c:url value='/thematic_1_9/Shop/assets/img/blog/11.jpg'/>" alt=""></a>
						<a class="product-review" href="shop-ui-inner.html">Quick review</a>
						<a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
				...
				<li class="item">
					<div class="product-img">
						<a href="shop-ui-inner.html"><img class="full-width img-responsive" src="<c:url value='/thematic_1_9/Shop/assets/img/blog/12.jpg'/>" alt=""></a>
						<a class="product-review" href="shop-ui-inner.html">Quick review</a>
						<a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
				...
				<li class="item">
					<div class="product-img">
						<a href="shop-ui-inner.html"><img class="full-width img-responsive" src="<c:url value='/thematic_1_9/Shop/assets/img/blog/10.jpg'/>" alt=""></a>
						<a class="product-review" href="shop-ui-inner.html">Quick review</a>
						<a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
					</div>
					<div class="product-description product-description-brd">
		...
		<div class="row illustration-v2">
			<div class="col-md-3 col-sm-6 md-margin-bottom-30">
				<div class="product-img">
					<a href="shop-ui-inner.html"><img class="full-width img-responsive" src="<c:url value='/thematic_1_9/Shop/assets/img/blog/25.jpg'/>" alt=""></a>
					<a class="product-review" href="shop-ui-inner.html">Quick review</a>
					<a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
				</div>
				<div class="product-description product-description-brd">
		...
		<div class="row illustration-v4 margin-bottom-40">
			<div class="col-md-4">
				...
				<div class="thumb-product">
					<img class="thumb-product-img" src="<c:url value='/thematic_1_9/Shop/assets/img/thumb/08.jpg'/>" alt="">
				...
				<div class="thumb-product">
					<img class="thumb-product-img" src="<c:url value='/thematic_1_9/Shop/assets/img/thumb/09.jpg'/>" alt="">
					<div class="thumb-product-in">
						<h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
						<span class="thumb-product-type">Footwear - Oxfords</span>
					</div>
				...
				<div class="thumb-product">
					<img class="thumb-product-img" src="<c:url value='/thematic_1_9/Shop/assets/img/thumb/03.jpg'/>" alt="">
					<div class="thumb-product-in">
						<h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
						<span class="thumb-product-type">Footwear - Oxfords</span>
					</div>
			...
			<div class="col-md-4">
				...
				<div class="thumb-product">
					<img class="thumb-product-img" src="<c:url value='/thematic_1_9/Shop/assets/img/thumb/02.jpg'/>" alt="">
					<div class="thumb-product-in">
						<h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
						<span class="thumb-product-type">Footwear - Oxfords</span>
					</div>
				...
				<div class="thumb-product">
					<img class="thumb-product-img" src="<c:url value='/thematic_1_9/Shop/assets/img/thumb/10.jpg'/>" alt="">
					<div class="thumb-product-in">
						<h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
						<span class="thumb-product-type">Footwear - Oxfords</span>
					</div>
				...
				<div class="thumb-product">
					<img class="thumb-product-img" src="<c:url value='/thematic_1_9/Shop/assets/img/thumb/06.jpg'/>" alt="">
					<div class="thumb-product-in">
						<h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
						<span class="thumb-product-type">Footwear - Oxfords</span>
					</div>
			...
			<div class="col-md-4 padding">
				...
				<div class="thumb-product">
					<img class="thumb-product-img" src="<c:url value='/thematic_1_9/Shop/assets/img/thumb/07.jpg'/>" alt="">
					<div class="thumb-product-in">
						<h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
						<span class="thumb-product-type">Footwear - Oxfords</span>
					</div>
				...
				<div class="thumb-product">
					<img class="thumb-product-img" src="<c:url value='/thematic_1_9/Shop/assets/img/thumb/04.jpg'/>" alt="">
					<div class="thumb-product-in">
						<h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
						<span class="thumb-product-type">Footwear - Oxfords</span>
					</div>
				...
				<div class="thumb-product">
					<img class="thumb-product-img" src="<c:url value='/thematic_1_9/Shop/assets/img/thumb/05.jpg'/>" alt="">
					<div class="thumb-product-in">
						<h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
						<span class="thumb-product-type">Footwear - Oxfords</span>
					</div>
