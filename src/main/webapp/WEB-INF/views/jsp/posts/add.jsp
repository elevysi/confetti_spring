...
<form:hidden path="uuid"/>
	...
	<div class="row">
		<a class="btn-u btn-u-green modalOpen noSave"  href="<spring:url value='/uploads/manage/${post.uuid}?type=posts' />"><i class="glyphicon glyphicon-file"></i><spring:message code="label.posts.add.manageUploads"/></a>
	</div>
